...
**Gate To Glory** is a high-tempo mobile arcade runner that blends lightning-fast mathematical gate decision-making with tactical roguelike deck-building. This repository contains the Minimum Viable Product (MVP) phase of the project, built to demonstrate core gameplay loops, UI architecture, and object management in Unity.
...
* **Economy Balancing:** Refining the mathematical weights of the card market based on player wallet thresholds.
* **Expanded Roster:** Scaling up from the current 2-character prototype to a diverse pool of 15 unique units with distinct passive skills.
...
3. Press Play on any scene. (Automatically game runs on menu scene)